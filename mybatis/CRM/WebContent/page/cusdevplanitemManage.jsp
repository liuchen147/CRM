...
<script type="text/javascript">
	...
	function a(){
		window.parent.openTab('客户开发计划项管理','cusdevplanManage.jsp','icon-khkfjh');
	}
</script>

</head>
<body style="margin:15px">
	<div id="p" title="销售机会信息" class="easyui-panel" style="width:700px;height:400px;padding:10px;">
		<table cellspacing="8px">
			...
			<tr>
				<td>概要：</td>
				<td colspan="4"><input type="text" id="overView" name="overView" readonly="readonly" style="width:420px"/></td>
			</tr>
			<tr>
				<td>机会描述：</td>
				<td colspan="4">
	...
	rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>
				...
				<th field="planDate" width="100px" editor="{type:'datebox',options:{required:true}}">日期</th>
				<th field="planItem" width="100px" editor="{type:'validatebox',options:{required:true}}">计划内容</th>
				<th field="exeAffect" width="100px" editor="{type:'validatebox',options:{required:true}}">执行效果</th>
			</tr>
		</thead>
	</table>
	<c:if test="${param.detailed != 'show'}"> 
		<div id="toolbar">
			...
			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-zzkf" plain="true" onclick="updateSaleChanceDevResult(3)">开发失败</a>
		</div>
	</c:if>                                                                                                             
</body>
</html>