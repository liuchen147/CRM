...
<body>
	<table id="dg" title="客户服务处理管理" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true"
	...
	<div id="dlg" class="easyui-dialog" style="width:620px;height:520px;padding:10px 20px" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="post">
			<table cellspacing="8px">
				...
				<tr>
					<td>服务处理：</td>
					<td colspan="4">
						<textarea rows="5" cols="49" id="serviceProce" name="serviceProce" class="easyui-validate" required="true"></textarea>&nbsp;<font color="red">*</font>
					</td>
				</tr>
				<tr>
					<td>处理人：</td>
