	...
	<TBODY>
		...
		<TR style="HEIGHT: 254px">
			...
			<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
				<TBODY>
					<TR>
						<TD style="HEIGHT: 45px"><INPUT type="text" class=input value="${user.userName }" onkeyup="this.value=this.value.replace(/\s+/g,'')" name="userName" id="userName"></TD>
					</TR>
					<TR>
						<TD><INPUT type="password" class=input value="${user.password }" onkeyup="this.value=this.value.replace(/\s+/g,'')" name="password" id="password"/></TD>
					</TR>
					<TR>
						<td>
				...
				<TBODY>
					...
					<TR>
						...
						<TD width=100 align=middle><INPUT
							style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px"
							id=btnReset src="${pageContext.request.contextPath}/images/btn2.jpg" type=image name=btnReset onclick="javascript:adminloginreset();return false;"></TD>
					</TR>
				</TBODY>
			</TABLE>
			</DIV>
